...
class VarietyTripsView extends StatelessWidget {
  const VarietyTripsView({super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocConsumer<VarietyCubit, VarietyState>(
        listener: (context, state) {
          if (state is VarietyFailure) {
