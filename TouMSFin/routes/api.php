...
use App\Http\Controllers\ThenotificationsController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('payments', [PaymentController::class, 'store']); //user
    ...
    //UserTour
    Route::get('user/{userid}/tours', [UserController::class, 'getUserTours']);
    ...
    Route::post('/request-guide', [DestinationController::class, 'requestGuide']);
    ...
    //Notification
    Route::post('nots', [ThenotificationsController::class, 'createNotification'])->middleware('CheckUserRole');
    Route::post('notificationstousers/{id}', [ThenotificationsController::class, 'addPaymentNotificationsToUser'])->middleware('CheckUserRole');
    Route::post('nt', [ThenotificationsController::class, 'addAdminNotificationsToAllUsers'])->middleware('CheckUserRole');
    ...
    Route::get('userSupports', [SupportController::class, 'getFaqToUsers']);

    //BookingFlight
    Route::get('booking/{bookingid}/flights', [FlightController::class, 'getBookingFlights']); //user
    Route::get('flights/{flightid}/bookings', [BookingController::class, 'getFlightBookings']); //user
    ...
    //BookingHotel
    Route::get('booking/{bookingid}/hotels', [HotelController::class, 'getBookingHotels']); //user
    Route::get('hotels/{hotelid}/bookings', [BookingController::class, 'getHotelBookings']); //user
    ...
    //BookingTour
    Route::get('booking/{bookingid}/tours', [TourController::class, 'getBookingTours']); //user
    ...
    Route::post('hotttttttttttt', [HotelController::class, 'store'])->middleware('CheckUserRole');
    ...
    //get
    Route::get('hot', [HotelController::class, 'index']);
    Route::get('flightone', [FlightController::class, 'index']);
    Route::get('flightone/{id}', [FlightController::class, 'show']);

    Route::get('t', [TourController::class, 'index']);
    Route::get('t/{id}', [TourController::class, 'show']);
    Route::get('d', [DestinationController::class, 'index']);
    Route::get('d/{id}', [DestinationController::class, 'show']);
    Route::get('offerg/{id}', [OfferController::class, 'show']);
    Route::get('offerg', [OfferController::class, 'index']);
